 🏠 Case 1: Ubuntu on the same network
...
hostname -I
```
![alt text](./imagessh/2..png)
You’ll get something like 192.168.1.42.

## ✅ Step 3: Connect from friend laptop 

On your terminal, open Terminal and run:
...
# 🌐 Case  Ubuntu on different networks (e.g., home ↔ office or remote server)
...
![alt text](./imagessh/3.png)

![alt text](./imagessh/4.jpeg)

![alt text](./imagessh/5.jpeg)

![alt text](./imagessh/1.png)
...
![alt text](./imagessh/6.png)

![alt text](./imagessh/7.png)
